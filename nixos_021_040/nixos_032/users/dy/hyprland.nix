...
bind = $mainMod, Z, exec, noctalia-shell ipc call launcher toggle
bind = $mainMod, P, pseudo, # dwindle
bind = $mainMod, J, layoutmsg, togglesplit # dwindle
bind = $mainMod ALT, W, exec, noctalia-shell ipc call wallpaper toggle
...
# 按下 SUPER + W 启动 nautilus 文件管理器
#bind = $mainMod, W, exec, nautilus --new-window

# 按下 SUPER + E 启动 Thunar 文件管理器
