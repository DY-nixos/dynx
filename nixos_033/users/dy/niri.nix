...
binds {
    ...
    Mod+Alt+W {spawn "noctalia-shell" "ipc" "call" "wallpaper" "toggle";}
    Mod+F1 {spawn-sh "pkill fcitx5 || fcitx5 ";}


    // Suggested binds for running programs: terminal, app launcher, screen locker.
    Mod+T hotkey-overlay-title="Open a Terminal" { spawn "alacritty" "-e" "fish" ;}
    Mod+Shift+T { spawn "alacritty"; }
    //Mod+Alt+E hotkey-overlay-title="Open a FilesManager: nautilus" { spawn "thunar"; }
    Mod+Alt+E {spawn "nautilus" "--new-window";}
    Mod+E {spawn "thunar";}
    Mod+B hotkey-overlay-title="打开浏览器: firefox" { spawn "firefox"; }
    Mod+Shift+B hotkey-overlay-title="打开浏览器: google-chrome-stable" { spawn "google-chrome-stable"; }
    Mod+Shift+Z hotkey-overlay-title="Run an Application: fuzzel" { spawn "fuzzel"; }
    Mod+Alt+L hotkey-overlay-title="Lock the Screen: swaylock" { spawn "swaylock"; }
    Mod+P hotkey-overlay-title="Pick a color" { spawn-sh "hyprpicker | wl-copy"; }
    //Mod+F2 {spawn-sh "pkill waybar & pkill cava || true &&  waybar ";}
    Mod+Alt+V {spawn-sh "copyq toggle || clipse-gui";}
    ...
    //Super+Alt+V {spawn "copyq" "toggle";}
    ...
    // You can use regular spawn with multiple arguments too (to avsoid going through "sh"),
    ...
    Mod+Ctrl+Insert { screenshot-window; }
    Mod+Insert { screenshot-screen; }
    ...
    Mod+Shift+Ctrl+Q { spawn "wlogout"; }
    Mod+Shift+E { quit; }
